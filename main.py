...
class Agent:
    ...
    def __init__(self):
        ...
        self.gamma=0.9 #discount rate...less than 1 always
        self.memory=deque(maxlen=MAX_MEMORY)
        self.model=Linear_QNet(11,256,3) #3 values in the action,11 values as state, hidden can be anything
    ...
    def get_action(self,state):
        #random moves--> trade-off b/w exploration/exploitation
